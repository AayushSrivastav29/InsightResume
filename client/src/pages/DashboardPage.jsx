...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const averageScore =
        analysesResponse.data?.length > 0
          ? analysesResponse.data.reduce(
              (acc, analysis) =>
                acc + (analysis.analysis?.matchPercentage || 0),
              0
            ) / analysesResponse.data.length
          : 0;
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white">
          <div className="text-center">
            ...
            <p className="text-blue-100 mb-6">
              Upload a resume and job description to get instant AI-powered
              feedback
            </p>
