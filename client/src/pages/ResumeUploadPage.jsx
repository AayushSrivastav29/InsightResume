          ...
          {parsedData && (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Skills */}
                {parsedData.resume.extractedData?.skills &&
                  parsedData.resume.extractedData.skills.length > 0 && (
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">
                        Skills
                      </h3>
                      <div className="flex flex-wrap gap-2">
                        {parsedData.resume.extractedData.skills.map(
                          (skill, index) => (
                            <span
                              key={index}
                ...
                {/* Experience */}
                {parsedData.resume.extractedData?.experience &&
                  parsedData.resume.extractedData.experience.length > 0 && (
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">
                        Experience
                      </h3>
                ...
                {/* Education */}
                {parsedData.resume.extractedData.education.map((edu, index) => (
                ...
                {/* Certifications */}
                {parsedData.resume.extractedData?.certifications &&
                  parsedData.resume.extractedData.certifications.length > 0 && (
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">
                        Certifications
                      </h3>
                      <div className="space-y-2">
                        {parsedData.resume.extractedData.certifications.map(
                          (cert, index) => (
                            <div
                              key={index}
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  ...
                  <div className="max-h-64 overflow-y-auto bg-gray-50 rounded-lg p-4">
                    <pre className="text-sm text-gray-700 whitespace-pre-wrap">
                      {parsedData.resume.textPreview.substring(0, 1000)}
                      {parsedData.resume.textPreview.length > 1000 && "..."}
                    </pre>
                  </div>
                </div>
              )}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      PDF, DOC, or DOCX files work best
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
